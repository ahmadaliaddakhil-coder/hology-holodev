  ...
  return (
    ...
    <div className="min-h-screen min-w-[300px] bg-[#f3f3ec] text-[#15240a] font-sans overflow-hidden flex relative">
      ...
      {/* MAIN CONTENT WRAPPER */}
        ...
        {/* TOPBAR STANDAR */}
        <header className="fixed top-0 z-20 flex h-14 shrink-0 items-center justify-between bg-[#f3f3ec]/90 px-4 backdrop-blur-md sm:px-6 lg:px-8 border-b border-[#deded4]/40">
