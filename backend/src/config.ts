...
export const config = {
  ...
  clientOrigins: (process.env.CLIENT_ORIGIN ?? 'https://hology.eepis.web.id,http://localhost:5173,http://127.0.0.1:5173,http://localhost:5174,http://127.0.0.1:5174,http://localhost:8443,http://127.0.0.1:8443')
    .split(',')
